...
/**
 Base class for all Push_Offer views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Push_Offer view hierarchy (such as wrapped iOS UIViews) was touched.
