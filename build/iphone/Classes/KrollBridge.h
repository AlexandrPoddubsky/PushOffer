...
@interface Push_OfferObject : KrollCoverageObject {
#else
@interface Push_OfferObject : KrollObject {
#endif
@private
...
extern NSString * Push_Offer$ModuleRequireFormat;
