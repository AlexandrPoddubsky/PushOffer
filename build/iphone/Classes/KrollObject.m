...
//@interface Push_OfferObject : NSObject
//@end

@interface Push_OfferObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Push_OfferObject class]])
		{
			for (NSString *key in [[(Push_OfferObject*)o modules] allKeys])
			{
