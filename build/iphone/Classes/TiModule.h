...
/**
 The base class for all Push_Offer modules
 */
...
/**
 Push_Offer Platform calls this method on startup.
 */
-(void)startup;

/**
 Push_Offer Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Push_Offer Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Push_Offer Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Push_Offer Platform calls this method on resume.
 @param sender The sender of the event.
 */
